...
<div class="content">
  ...
  <div class="container">
    ...
    <c:if test="${product != null}">
      ...
      <p><strong>Danh Mục:</strong> ${product.productCategory.categoryname}</p>
      <p><strong>Nhà Cung Cấp:</strong> ${product.supplier.supplierName}</p>
      <p><strong>Mô Tả:</strong> ${product.description}</p>
      <p><strong>Ngày Nhập:</strong> ${product.entrydate}</p>
      <img src="${pageContext.request.contextPath}/uploads/${product.productimage}" alt="${product.productname}" class="img-fluid">
    </c:if>
    <c:if test="${product == null}">
