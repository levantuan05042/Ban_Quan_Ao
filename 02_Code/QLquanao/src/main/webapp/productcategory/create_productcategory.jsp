...
<div class="content">
    <div class="container">
        <h1 class="text-center mb-4">Thêm Danh Mục Sản Phẩm</h1>
        <form action="/productcategory?action=createPost" method="post">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <a href="/productcategory" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Quay Về Danh Mục</a>
            </div>
        </form>
    </div>
</div>
